const repo=require('../../repositories/content.repository'); const {success}=require('../../utils/apiResponse'); const mapping={stories:'stories',news:'news',events:'events',restaurants:'restaurants','safety-tips':'safetyTips',weather:'weather'};
